<?php
    ...
    $id = $_GET['idperson'];
    $get = mysqli_query($koneksi, "SELECT * FROM person_066 WHERE idperson=$id");
        ...
        <div class="m-3">
            ...
            ?>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="date" value="<?php echo $data['tanggallahir'] ?>"
                                name="date" placeholder="kota">
                        </div>
                        <div class="form-group mb-3">
                            <label for="alamat" class="form-label">Alamat</label>
                            <textarea maxlength="39" class="form-control" name="alamat"
                        ...
                        <div class="form-group mb-3">
                            <button type="submit" value="Upload Image" name="simpan" class="btn btn-outline-primary mb-3">Edit
                                Data</button>
                        </div>
                    </form>
                </td>
                <td rowspan='5' class='px-5 align-top'>
                    <img height='350px' src="<?php echo $data['foto'] ?>" alt="">
                </td>
            </table>
        </div>
</body>
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        if (basename($_FILES["fileToUpload"]["name"]) != "") {
            ...
            mysqli_query($koneksi, "UPDATE person_066 SET 
                foto='$target_file'
            WHERE idperson='$id'
