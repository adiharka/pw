    ...
    <a class='' href="index.php"><button type="button" class="btn btn-outline-primary m-3">&lt Kembali</button></a>
        <form class="m-3" onsubmit="return validateForm()" style="max-width:400px" method="POST" action=""
            ...
            <div class="form-group mb-3">
                ...
                <textarea maxlength="39" class="form-control" id='alamat' name="alamat" rows="3"></textarea>
            </div>
            <div class="form-group mb-3">
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        mysqli_query($koneksi, "INSERT INTO person_066 VALUES(
            default,'$nama','$gender','$kota','$tanggal','$alamat','$kota', 'default.png', '1'
