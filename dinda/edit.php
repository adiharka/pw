<?php
    ...
    $id = $_GET['idperson'];
    $get = mysqli_query($koneksi, "SELECT * FROM person_024 WHERE idperson=$id");
...
<body>
    <h5 class='p-3 text-light bg-dark'>Dinda Salsabila Yaswi - 081911633024</h5>
    <a class='mx-3' href="index.php"><button type="button" class="btn btn-primary">Kembali</button></a>
    <h1 class="m-3">Mengedit data</h1>
    <div class="m-3">
        <table>
            <td>
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        if (basename($_FILES["fileToUpload"]["name"]) != "") {
            ...
            mysqli_query($koneksi, "UPDATE person_024 SET 
                foto='$target_file'
            WHERE idperson='$id'
