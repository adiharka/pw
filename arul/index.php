...
<body>
    <div style='max-width:1024px;display:flex;justify-content:center;flex-direction:column;margin:auto'>
        <h2 class="m-3 text-center">Selamat datang</h2>
        <div>
        ...
        <div class="m-3">
            ...
            <div class="">
                <table class="table table-bordered mb-0">
                    ...
                    $number = 1;
                    $empty = 0;
                    $show = mysqli_query($koneksi, "SELECT * FROM person_037");?>
        ...
        <p class='text-center'>M.SYAHRUL ALIFATHURRAHMAN - 081911633037</p>
    </div>
</body>
