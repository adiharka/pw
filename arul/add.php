...
<body>
    <div class='p-3 pt-0'
        style='max-width:1024px;display:flex;justify-content:center;flex-direction:column;margin:auto'>
        <h2 class="m-3 text-center">Tambah Data</h2>
        <div>
            <a class='mx-3' href="index.php"><button type="button" class="btn btn-primary mb-3">Kembali</button></a>
        </div>
        <form class="m-3" onsubmit="return validateForm()" style="max-width:400px" method="POST" action=""
            name="person">
            <div class="mb-3">
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        mysqli_query($koneksi, "INSERT INTO person_037 VALUES(
